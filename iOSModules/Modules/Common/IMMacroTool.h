...
#define IMMacroTool_h
    ...
    #define IMRectLog(aRect)            NSLog(@"Rect.orgion.x = %lf | Rect.orgion.y = %lf | Rect.size.width = %lf | Rect.size.height = %lf",aRect.origin.x,aRect.origin.y,aRect.size.width,aRect.size.height)
